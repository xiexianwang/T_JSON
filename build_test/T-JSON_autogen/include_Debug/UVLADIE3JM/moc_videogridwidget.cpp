...
template <> constexpr inline auto VideoGridWidget::qt_create_metaobjectdata<qt_meta_tag_ZN15VideoGridWidgetE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Signal 'cellSelectionFinished'
        QtMocHelpers::SignalData<void(int, int, int, int, int)>(5, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Int, 3 }, { QMetaType::Int, 6 }, { QMetaType::Int, 7 }, { QMetaType::Int, 8 },
            { QMetaType::Int, 9 },
        }}),
    };
...
void VideoGridWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->cellSelected((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        case 1: _t->channelRemoved((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        case 2: _t->cellSelectionFinished((*reinterpret_cast<std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<int>>(_a[2])),(*reinterpret_cast<std::add_pointer_t<int>>(_a[3])),(*reinterpret_cast<std::add_pointer_t<int>>(_a[4])),(*reinterpret_cast<std::add_pointer_t<int>>(_a[5]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (VideoGridWidget::*)(int )>(_a, &VideoGridWidget::cellSelected, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (VideoGridWidget::*)(int )>(_a, &VideoGridWidget::channelRemoved, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (VideoGridWidget::*)(int , int , int , int , int )>(_a, &VideoGridWidget::cellSelectionFinished, 2))
            return;
    }
}
...
// SIGNAL 0
void VideoGridWidget::cellSelected(int _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void VideoGridWidget::channelRemoved(int _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 1, nullptr, _t1);
}

// SIGNAL 2
void VideoGridWidget::cellSelectionFinished(int _t1, int _t2, int _t3, int _t4, int _t5)
{
